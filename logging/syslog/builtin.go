...
// priority and prefix.
func newBuiltin(priority Priority, tag string) (w *builtinWriter, err error) {
...
func dialBuiltin(network, raddr string, priority Priority, tag string) (*builtinWriter, error) {
...
func (w *builtinWriter) writeAndRetry(p Priority, s string) (int, error) {
...
func (w *builtinWriter) write(p Priority, msg string) (int, error) {
	// ensure it ends in a \n
	nl := ""
